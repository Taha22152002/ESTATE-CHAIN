...
export function useMyProperties(limit = 10, offset = 0) {
  ...
  const fetchMyProperties = useCallback(async () => {
    ...
    try {
      setLoading(true);
      const propertyIds = await contract.getPropertiesByOwner(
        address,
        limit,
        offset
      );
  ...
  }, [contract, address, fetchMyProperties]);
